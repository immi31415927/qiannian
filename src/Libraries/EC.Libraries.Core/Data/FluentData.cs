...
namespace EC.Libraries.Core.Data
{
    internal class ActionsHandler
    {
        ...
        {
            var parameterName = "w_" + columnName;//唐田，更新查询条件的参数名称，添加w前缀，表示where，用于区别修改内容参数和条件参数冲突
    ...
    public interface ISelectBuilder<TEntity>
    {
        ...
        ISelectBuilder<TEntity> Parameters(Dictionary<string, object> parameters);
    ...
    internal class SelectBuilder<TEntity> : ISelectBuilder<TEntity>
    {
        ...
        public ISelectBuilder<TEntity> Parameters(Dictionary<string, object> parameters)
        {
            Data.Command.Parameters(parameters);
            return this;
        }
    ...
    public interface IDbCommand : IExecute, IExecuteReturnLastId, IQuery, IParameterValue, IDisposable
    {
        ...
        IDbCommand Parameters(Dictionary<string, object> parameters);
    ...
    internal partial class DbCommand
    {
        ...
        public IDbCommand Parameters(Dictionary<string, object> parameters)
        {
            if (parameters != null)
            {
    ...
    public class MySqlProvider : IDbProvider
    {
        ...
        public string GetSqlForSelectBuilder(SelectBuilderData data)
        {
            ...
            if (data.PagingItemsPerPage > 0
                && data.PagingCurrentPage > 0)
            {
                sql += string.Format(" limit {0}, {1}", data.GetFromItems() - 1, data.PagingItemsPerPage);//更新Mysql分页bug
            }
